...
pagination-info-invoices = Сторінка {$page} з {$totalPages}. Нарахування {$numOfItemsOnPage} з
    ${$totalItems}.
...
pagination-info-payments = Сторінка {$page} з {$totalPages}. Списання {$numOfItemsOnPage} з
    ${$totalItems}.
